    ...
    <div class="menu row w300">
            <h1> 마이페이지</h1>
                <div class="row center">
                	<a href="<%=request.getContextPath() %>/buy/list.jsp">구매내역</a></div>
               ...
               <div class="row center"><a href="<%=request.getContextPath() %>/board/qna_list" class="link link-btn"><h1>1:1문의하기</h1></a></div>
      </div>
