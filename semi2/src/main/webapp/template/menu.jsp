	...
	<div>
            ...
            <br>
                <div class="row center">
                	<a href="<%=request.getContextPath() %>/buy/list.jsp?<%=memberDto.getMemberId()%>">구매내역</a>
                	</div>
                	<div class="row center"><a href="<%=request.getContextPath()%>/cart/list.jsp">장바구니 내역</a></div>
                	<div class="row center"><a href="<%=request.getContextPath()%>/like/list.jsp">찜 목록</a></div>
                ...
                <div class="row center"><a href="<%=request.getContextPath()%>/board/productqna_list.jsp?type=board_writer&keyword=<%=memberDto.getMemberId()%>">내 상품문의내역</a></div><br>
