 ...
 <script src="https://code.jquery.com/jquery-3.6.0.js"></script>
  <script type="text/javascript">
	...
	<div class="container w500 m30">
		...
		<div class="row">
			<label>아이디</label>
			<input type="text" name="memberId" placeholder="영문 소문자/숫자 8~20자" autocomplete="off" class="form-input fill"  required>
		</div>
		<div class="row">
			<label>비밀번호</label>
	        <input type="password" name="memberPw" placeholder="영문대문자로 시작하여 영어, 숫자, 특수문자 8~16자" class="form-input fill"  required>
	    </div>
	    <div class="row">
	        <label>닉네임</label>
	            <input type="text" name="memberNick" placeholder="한글 10자 이내" autocomplete="off"  class="form-input fill" required>
	    </div>
	    <div class="row">
	    	<label>이름</label>
	    		<input type="text" name="memberName" placeholder="이름" autocomplete="off" class="form-input fill"  required>
	    </div>
	    <div class="row">
	        <label>생년월일</label>
	        <input type="date" name="memberBirth" autocomplete="off"  class="form-input fill" required>
	    </div>
	    <div class="row">
	        <label>전화번호</label>
	        <input type="tel" name="memberPhone" placeholder="숫자만 입력" autocomplete="off"  class="form-input fill" required>
	    </div>
	    <div class="row">
	        <label>이메일</label>
	        <input type="email" name="memberEmail" autocomplete="off"  class="form-input fill" required>
	    </div>
	    <div class="row">
	        <label>주소</label><br>
       ...
       <div class="row">
       		<input type="text" name="memberBasicAddress" placeholder="기본주소" autocomplete="off"  class="form-input fill" required>
       </div>
       <div class="row">
            <input type="text" name="memberDetailAddress" placeholder="상세주소" autocomplete="off"  class="form-input fill" required>
	    </div>
	    <div class="row">
	    		<label>회원포인트</label>
	    		<input type="number" name="memberPoint" required min="0" step="100"  class="form-input fill" required>
	    </div>
	    <div class="row" >
	    		<label>회원등급</label>
