		...
		<table class="table table-border table-hover" >
			<thead>
				...
				<tr>
					...
					<img src="/semi2/file/download.ez?attachmentNo=11<%--<%=productattachmentDto.getAttachmentNo()%>--%>"  width="200" height="200">
					</a></td>
		...
		<table class="table table-border table-hover" >
			...
			<tbody>
				...
				<tr>
					<%-- <td><%=productDto.getProductSort() %></td>--%>
					<td><a href="product_user_detail.jsp?product_no=<%=productDto.getProductNo()%>" class="link">
					<img src="/semi2/file/download.ez?attachmentNo=11<%--<%=productattachmentDto.getAttachmentNo()%>--%>"  width="200" height="200"></a></td>
					<td><%=productDto.getProductName()%></td>
					<td><%=productDto.getProductPrice()%></td>
					</tr>
					<%}%>
