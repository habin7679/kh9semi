...
public class BoardDto {
	...
	private int csProductNo;
	private String csProductWriter;
	...
	public int getCsProductNo() {
		return csProductNo;
	}
	public void setCsProductNo(int csProductNo) {
		this.csProductNo = csProductNo;
	}
	public String getCsProductWriter() {
		return csProductWriter;
	}
	public void setCsProductWriter(String csProductWriter) {
		this.csProductWriter = csProductWriter;
	}
